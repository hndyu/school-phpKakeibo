...
<body>
    <div class="container">
        ...
        <form action="create.php" method="post" class="m-5">
            ...
            <div class="form-group">
                <div class="form-check form-check-inline">
                    <input type="radio" name="type" id="income" class="form-check-input" value="0" checked>
                    <label for="income" class="form-check-label">収入</label>
                </div>
                <div class="form-check form-check-inline">
                    <input type="radio" name="type" id="spending" class="form-check-input" value="1">
